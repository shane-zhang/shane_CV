...
\resheading{教育背景}
	\begin{itemize}
		\item
			\ressubheading{\href{http://www.xjtu.edu.cn}{Xi'an Jiaotong University}}{Xi'an,China}{\href{http://www.cs.xjtu.edu.cn}{计算机科学与技术};}{Sep. 2009 -- Jan. 2012}
...
\resheading{技能}
	\begin{description}
		\item[编程语言:] { \footnotesize C/C++,Java,Assembly(x86/MIPS),MFC,LaTeX,HTML, CSS,JavaScript,AJAX,PHP}
